...
<head>
	...
	<title>Car Rental Portal||update Contact</title>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>Failure</strong>:<?php echo htmlentities($error); ?> </div><?php } 
...
<?php }} ?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-sm btn-primary" name="submit" type="submit">Update</button>
												</div>
											</div>
